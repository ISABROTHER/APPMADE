  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.sub}>Your card is shown on the Profile screen. This page is reserved for a full-screen version.</Text>
      </View>

      <View style={styles.body}>
        <View style={styles.glass}>
          <Text style={styles.note}>
            Next step: if you want, I can render the same digital card here in full screen (front/back + share/scan UI)
...
const styles = StyleSheet.create({
  ...
  note: { fontSize: 13, fontWeight: '800', color: 'rgba(11,18,32,0.78)', lineHeight: 18 },
});

...
function FauxQr() {
  // Deterministic “QR-like” pattern without dependencies
  const cells = useMemo(() => {
    const out: boolean[] = [];
    ...
    <View style={styles.qrWrap} accessibilityLabel="Verification code">
      {cells.map((on, idx) => (
        <View
          ...
          key={idx}
          style={[styles.qrCell, on ? styles.qrOn : styles.qrOff]}
        />
      ))}
    </View>
  );
        ...
        >
          ...
          <View style={styles.backContent}>
            ...
            <Text style={styles.backSub}>
              Present this code to confirm identity in-app.
            </Text>
...
export default function ProfileScreen() {
  ...
  const handleSignOut = async () => {
    try {
      ...
      // keep silent UI; you can add toast later if needed
